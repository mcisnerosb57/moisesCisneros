(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('artefactsCheckApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-artefactsCheckApp-error');
                var entityKey = httpResponse.headers('X-artefactsCheckApp-params');
                if (errorHeader) {
